...
INSERT INTO issues (id, title, description, status, priority, assignee_id, created_at) VALUES
  ...
  (
    'face0001-0000-0000-0000-000000000002',
  ...
  (
    'face0001-0000-0000-0000-000000000003',
  ...
  (
    'face0001-0000-0000-0000-000000000004',
  ...
  (
    'face0001-0000-0000-0000-000000000005',
  ...
  (
    'face0001-0000-0000-0000-000000000006',
...
INSERT INTO comments (id, issue_id, body, author_id, created_at) VALUES
  ...
  (
    'c0de0001-0000-0000-0000-000000000004',
    'face0001-0000-0000-0000-000000000003',
...
INSERT INTO issue_labels (issue_id, label_id) VALUES
  ('face0001-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), -- bug
  ('face0001-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'), -- feature
  ('face0001-0000-0000-0000-000000000002', 'cccccccc-cccc-cccc-cccc-cccccccccccc'), -- improvement
  ('face0001-0000-0000-0000-000000000003', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee'), -- performance
  ('face0001-0000-0000-0000-000000000004', 'dddddddd-dddd-dddd-dddd-dddddddddddd'), -- docs
  ('face0001-0000-0000-0000-000000000005', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), -- bug
  ('face0001-0000-0000-0000-000000000006', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb')  -- feature
